    ...
    <div class="vw-100 vh-100 d-flex justify-content-center align-items-center ">
        <div class="login-content border rounded-3 overflow-hidden shadow position-relative">
            ...
            <div id="content" class=" h-100 align-items-center justify-content-center align-self-center px-4 ">
                ...
                <form action="" style="display: grid; grid-template-rows:1fr 1fr; gap: 10px;">
                    <div>
                    ...
                    <div>
                        ...
                        <input type="password" name="password" id="password" placeholder="********" class="form-control" style="border: 1px solid #022f63 !important;" />
                    </div>
