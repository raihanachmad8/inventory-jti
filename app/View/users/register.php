        ...
        $(document).ready(() => {
            ...
            $(document).on('click', '#lanjutkan_button1', () => {
                if (($("#btnMahasiswa").hasClass('active')) || ($("#btnDosen").hasClass('active'))) {
                    ...
                    // $('#content').append(`<div class="alert alert-danger alert-dismissible fade show" role="alert"> Mohon pilih role anda terlebih dahulu <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button></div>`)
                }
            })

            $(document).on('click', '#lanjutkan_button2', () => {
                if ($('#nomor_hp').val() != '' && $('#Nama').val() != '' && $('#Nomor_Identitas').val() != '') {
                    if (formData.has('nomor_hp')) {
                        formData.set('nomor_hp', $('#nomor_hp').val())
                    } else {
                    ...
                    if (formData.has('nomor_identitas')) {
                        formData.set('nomor_identitas', $('#nomor_identitas').val())
                    } else {
            ...
            $(document).on('click', '#lanjutkan_button3', (e) => {
                if ($('#email').val() != '' && $('#password').val() != '' && $('#confirm_password').val() != '') {
                    ...
                    if (formData.has('confirm_password')) {
                        ...
                        formData.append('confirm_password', $('#konfirmasi_password').val())
                    }
                    console.log(formData)
                    e.preventDefault()
                    $.ajax({
                ...
                <form action="" style="display: grid; grid-template-rows:1fr; gap: 3rem;">
                    <div>
                        <div class="mt-2">
                            ...
                            <input type="text" id="nomor_identitas" name="nomor_identitas" placeholder="NIM / NIP" class="form-control  " style="border: 1px solid #022f63 !important;">
                        </div>
                        <div class="mt-2">
                        ...
                        <div class="mt-2">
                            <div>
                                <label class="sr-only" for="nomor_hp">Nomor Telepon</label>
                                <div class="input-group mb-2">
                                    <div class="input-group-prepend">
                                        <div class="input-group-text rounded-0 rounded-start-3 " style="border: 1px solid #022f63 !important;">+62</div>
                                    </div>
                                    <input type="text" class="form-control" id="nomor_hp" name="nomor_hp" placeholder="89xxxxxxx" style="border: 1px solid #022f63 !important;">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <form action="" style="display: grid; grid-template-rows:1fr; gap: 3rem;">
                    <div>
                        ...
                        <div class="mt-2">
                            ...
                            <input type="password" id="confirm_password" name="confirm_password" class="form-control" placeholder="********" style="border: 1px solid #022f63 !important;">
                        </div>
                    </div>
                    </form>
