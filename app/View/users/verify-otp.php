    ...
    <div class="vw-100 vh-100 d-flex justify-content-center align-items-center ">
        <div class="login-content border rounded-3 overflow-hidden shadow">
            ...
            <div id="content" class="h-100 align-items-center justify-content-center align-self-center px-4">
                ...
                <form action="" style="display: grid; grid-template-rows:1fr; gap: 3rem; justify-content: center; justify-items: center">
                ...
                <button class="btn rounded-3 w-100 text-white mb-3" id="lanjutkan_button1" style="background-color: #023670;">Lanjutkan</button>
