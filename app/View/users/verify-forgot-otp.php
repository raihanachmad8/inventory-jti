...
<h1><?= $model['title'] ?? 'Verification Code Forgot' ?></h1>
<form action="/users/forgot/verification?ID_Pengguna=<?= $_GET['ID_Pengguna'] ?>&Email=<?= $_GET['Email']?>&o=<?= $_GET['o']?>" method="post">
...
<a href="/users/forgot/resend-verification?ID_Pengguna=<?= $_GET['ID_Pengguna'] ?>&Email=<?= $_GET['Email']?>">Resend OTP</a>
