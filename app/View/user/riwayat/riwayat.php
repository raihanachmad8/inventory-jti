    ...
    <table class="history-table">
      ...
      <tbody>
        <tr>
          ...
          <td><button class="button-detail-loan btn" style="background-color: #CEE7FF; color:#01305D;">Detail</button></td>
        </tr>
      </tbody>
    </table>
  </div>
...
<div class="modal-detail-container position-absolute w-100 h-100 bg-white d-flex flex-column justify-content-between d-none " style="color: #01305D;">
  ...
  <div class="py-4 d-flex justify-content-end column-gap-3 ">
    <button class="button-back-history btn btn-primary">Kembali</button>
    <button class="button-cancel-history btn btn-danger">Batalkan</button>
  </div>
</div>