...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;700;800;900&family=Roboto:wght@100;300;400;500;700&display=swap" rel="stylesheet">
</head>
<body>
...
<nav class="nav fixed-top vw-100" style="z-index: 9999; background-color: rgba(0,0,0,0.4);">
    <div class="container-fluid d-flex justify-content-between">
        <img src="/public/assets/image/logo-polinema-lp.png" alt="Logo" width="70" height="70" />
...
<div id="about" class="container-fluid d-flex flex-column justify-content-center align-items-center py-5" style="background-color: #02357029;" >
    <div class="mb-5"></div>
    <img class="mb-1" src="/public/assets/image/quote.png" />
...
<!-- <div id="invitation" class="container-fluid d-flex justify-content-center align-items-center" style=" background-color: #02357029; ">
</div> -->

<!-- Card Feature-->
<div id="feature" class="container-fluid d-flex flex-column justify-content-center">
    <div class="mb-5"></div>
    ...
    <div class="feature-container rounded column-gap-3">
        <div class="card mb-3 w-100" style="height: 18rem">
            <div class="card-body">
                <img src="/public/assets/image/icon-fitur-peminjaman.png" />
...
<!-- Team -->
<div id="team" class="container-fluid d-flex justify-content-center w-100 d-flex flex-column">
    <div class="mb-5"></div>
    ...
    <div class="team-container mx-auto">
        <div class="mb-2 d-flex bg-body-tertiary p-3 rounded-4" style="background-color: #074a8100;">
            <div class="text-center d-flex justify-content-center align-items-center w-50">
                <img src="/public/assets/image/user.png" class="" class="w-100 h-100" />
            </div>
