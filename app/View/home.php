        ...
        <div class="team-container mx-auto">
            <div class="mb-2 d-flex gap-2 bg-body-tertiary p-3 rounded-2" style="background-color: #074a8100;">
                ...
                <div class=" d-flex flex-column ">
                    <div class="w-100 ">
                        ...
                        <p style="font-size: 0.7rem" class="text-black-50 ">Project Manager</p>
                    </div>
            ...
            <div class="mb-2 d-flex gap-2 bg-body-tertiary p-3 rounded-2" style="background-color: #074a8100">
                <div class="text-center w-50 h-100 ">
                    <img src="/public/assets/images/team/DSC09725.jpg" style="max-width: 7rem;" class="w-100 object-fit-cover rounded-circle " />
                </div>
                <div class=" d-flex flex-column ">
                    <div class="w-100 h-100 ">
